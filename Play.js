...
Play.prototype = {
    ...
    create: function () {
        ...
        sectorOne = gameBottom + sectorDevision;
        ...
        console.log(sectorOne + " " + sectorTwo + " " + sectorThree + " " + sectorFour + " " + sectorFive);
    ...
    //returns a table (2d array) with first row being which types of FlyingObjects
    //can be generated at that height
    //and second row being the probability of its generation
    //hwy the FRICK does js not have dicts
    // getSpawnProbabilities: function(height) {
